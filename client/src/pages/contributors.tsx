...
import { Users, Code, Award, BookOpen, ArrowRight, Globe, Bug, Medal, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-white/90 text-lg mb-8 md:pr-8">
                Contribute to the Auditt ecosystem as a researcher, developer, or knowledge contributor. Help build a more secure Web3 together.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-white text-[#00264d] hover:bg-white/90" size="lg">
                  Become a Contributor <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
                <Button className="bg-[#00264d]/10 border-2 border-white/20 backdrop-blur-sm text-white hover:bg-[#00264d]/20" size="lg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white rounded-xl p-8 border border-gray-100 shadow-md hover:shadow-lg transition-all flex flex-col h-full">
                <div className="mb-6">
                  {role.icon}
                </div>
                <h3 className="text-2xl font-semibold mb-3 text-gray-800">{role.title}</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-2 text-gray-900">Benefits of Contributing</h2>
          <p className="text-lg text-gray-600 mb-10 max-w-3xl">
            Join our network of security professionals and enjoy these exclusive benefits.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md border border-gray-100">
              <h3 className="text-2xl font-bold mb-6 text-gray-800">Contributor Recognition</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-100 hover:shadow-lg transition-all">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-1 text-gray-800">{contributor.name}</h3>
                  <p className="text-[#00264d] font-medium mb-3">{contributor.role}</p>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center max-w-3xl relative z-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">Ready to Make an Impact?</h2>
